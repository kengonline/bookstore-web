...
class PublisherCriteria extends Component {
    constructor(props) {
        super(props);
...
PublisherCriteria.propTypes = propTypes;
PublisherCriteria.defaultProps = defaultProps;

export default PublisherCriteria;